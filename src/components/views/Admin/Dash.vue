<template>
  <div :class="['wrapper', classes]">
	...
	<span class="logo-mini">
		<a href="/"><img src="/src/assets/images/copilot-logo-white.svg" alt="Logo" class="img-responsive center-block logo"></a>
	</span>
      <!-- Header Navbar -->
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{year}}
        <a href="javascript:;">Volcomer@FrostBye.media</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
</template>
